traversal .php files ，if the format like " return ["a"=>1,"b"=>2 ];",this function will read it from the input file path and transfer the information to one array. And it can also traversal directions！
